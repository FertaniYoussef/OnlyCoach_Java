...
public class Event {
    ...
    public Event(String nom, CategorieEvent categorie, Date date, String heure, String description, String lieu, int placesDisponibles, double cout, String image) {
        this.nom = nom;
        this.categorie = categorie;
        this.date = date;
        this.heure = heure;
  ...
  /*  public void addParticipant(User user) {
    ...
    */
    ...
    public String toString() {
        return "Event{" + "id=" + id + ", nom=" + nom + ", categorie=" + categorie.toString() + ", date=" + date + ", heure=" + heure + ", nomC=" + nomC + ", description=" + description + ", lieu=" + lieu + ", placesDisponibles=" + placesDisponibles + ", cout=" + cout + ", image=" + image + '}';
    }
