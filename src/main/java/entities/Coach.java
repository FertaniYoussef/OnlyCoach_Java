...
public class Coach extends User {
    ...
    public Coach(int id, String firstName, String lastName, String picture, int tel, String email, String password, String roles, String description, double price, double rating, Categorie categorie) {
